...
if __name__ == '__main__':
    ...
    parser.add_argument('--net', type = str, choices=['LeNet5', 'AlexNet', 'VGG16','VGG19','ResNet18','ResNet34',   
                                                       'DenseNet','MobileNetv1','MobileNetv2'], default='ResNet101', help='net type')
...
#               outputs =outputs[0]
                ...
                pbar2.update(1)
                fileObject1 = open("eixt-acc-resnet-101-top1-0.5.txt", "a")
                fileObject5 = open("eixt-acc-resnet-101-top5-0.5.txt", "a")
